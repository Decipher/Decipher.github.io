...
//
// The page's own words are replaced with stand-ins of the same length. They
// come from whichever backend built the site, so a developer's Drupal and a CI
// one produce different words, and the baseline would otherwise fail on content
// nobody styled. These test the design: the shell, the type, the dialog. What
// the articles say is the behaviour suite's business.

import { expect, test } from '@playwright/test'

import { mockText } from './mock-text.mjs'
