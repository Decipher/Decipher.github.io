...
const request = (url, { method = "GET", headers = {}, body = null } = {}) => new Promise((resolve, reject) => {
  const lib = url.startsWith("https:") ? https__default["default"] : http__default["default"];
...
const assetProxy = (assets, { timeout = 1e4 } = {}) => (req, res) => {
  ...
  const lib = target.startsWith("https:") ? https__default["default"] : http__default["default"];
...
exports.applyToHead = applyToHead;
exports.assetProxy = assetProxy;
exports.collectAssets = collectAssets;
exports["default"] = DruxtDecoupledSettingsModule;
